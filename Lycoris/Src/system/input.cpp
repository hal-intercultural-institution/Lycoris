...
{
	return mouseState.rgbButtons[0] & 0x80; // 押されたときに立つビットを検査
}

BOOL IsMouseLeftTriggered(void)
{
	return mouseTrigger.rgbButtons[0] & 0x80;
}
...
{
	return mouseTrigger.rgbButtons[1] & 0x80;
}
...
{
	return mouseTrigger.rgbButtons[2] & 0x80;
}
